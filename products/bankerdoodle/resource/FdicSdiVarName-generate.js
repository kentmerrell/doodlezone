...
for(var i=0; i<glossaryItems.length; i++){
    // "name" is a reservered word. Use "InstitutionName"
    var varname=glossaryItems[i].VarName=="name"?"InstitutionName":glossaryItems[i].VarName;
    console.log("    static " + varname + ' = "' + glossaryItems[i].VarName + '";')
}